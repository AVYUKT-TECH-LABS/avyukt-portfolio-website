  ...
  return (
    <article className="pt-12">
            ...
            <div className="flex flex-col space-y-8 md:w-1/2">
              ...
              <div>
                <p className="leading-relaxed text-center md:text-left px-4 md:px-0">
                  A website is your virtual marketer that presents your business
                  virtually.
                  <br />
                  <br />
                  Avyukt Tech Labs is an affordable web design and development
                  company based in New Delhi, India, catering to a number of
                  clients throughout the world.
                  <br />
                  <br />
                  From creating a website and mobile application, to promoting
                  it on various platforms, we never failed to create your dream
                  website and mobile application with perfect blend of graphics
                  and create a robust online presence through digital marketing
                  tactics.
                  <br />
                  <br />
                  We have built a strong reputation for delivering innovative
                  and specialized IT solutions to our valued clients. Our track
                  record and{" "}
                  <Link href="/portfolio">
                    <span className="text-amber-500">portfolio</span>
                  </Link>{" "}
                  speaks for itself, showcasing our commitment to excellence and
                  customer satisfaction.
                </p>
              </div>
            </div>
            <div className="relative flex flex-wrap items-start justify-end md:w-1/2 pt-4 md:pt-0">
      ...
      <section className="py-12 md:py-12">
        ...
        <div className="md:container md:mx-auto md:max-w-8xl w-full py-24 md:px-0 px-12">
          <div className="flex flex-col md:flex-row items-center justify-between md:space-x-8 space-y-8 md:space-y-0">
            <div className="flex flex-col justify-between">
              ...
              <p className="box-description">
                Our goal is to become a trusted web design company known for
                creating original, memorable designs that transform
                companies&aops; online personas. With our clients, we want to
                establish enduring relationships that will help them navigate
                the ever-evolving digital landscape and stay one step ahead. We
                aim to raise the bar for web design excellence by consistently
                pushing boundaries and embracing new trends.
              </p>
            </div>
            <div className="flex flex-col justify-between">
              <h3 className="box-title">Mission</h3>
              <p className="box-description">
                In order to help businesses establish a strong online presence,
                engage their target audience, and accomplish their digital
                goals, our mission is to design beautiful, user-friendly
                websites. To give our clients a competitive edge in the digital
                environment, we work hard to deliver great web design solutions
                that combine creativity, functionality, and cutting-edge
                technology.
              </p>
            </div>
          </div>
          <div className="flex flex-col md:flex-row items-center justify-between md:space-x-8 space-y-8 md:space-y-0 py-24">
