    ...
    <div className="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
      <div className="flex md:contents flex-row-reverse">
        <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto space-y-3">
          {/* <Image
            ...
            alt=""
          /> */}
          <h3 className="text-lg font-semibold lg:text-xl text-[#5857f9]">
            Analysis
          </h3>
        ...
        <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
          ...
          <div className="absolute w-6 h-6 -mt-3 bg-white border-4 border-[#5857f9] rounded-full top-1/2"></div>
        </div>
      </div>
      ...
      <div className="flex md:contents">
        <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
          ...
          <div className="absolute w-6 h-6 -mt-3 bg-white border-4 border-[#fb5457] rounded-full top-1/2"></div>
        </div>
        <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-6 col-end-10 mr-auto">
          <h3 className="text-lg font-semibold lg:text-xl text-[#fb5457]">
            Design
          </h3>
          <p className="mt-2 leading-6">
      ...
      <div className="flex md:contents flex-row-reverse">
        <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
          <h3 className="text-lg font-semibold lg:text-xl text-[#9c34f0]">
            Development
          </h3>
          <p className="mt-2 leading-6">
        ...
        <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
          ...
          <div className="absolute w-6 h-6 -mt-3 bg-white border-4 border-[#9c34f0] rounded-full top-1/2"></div>
        </div>
      </div>
      ...
      <div className="flex md:contents">
        <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
          ...
          <div className="absolute w-6 h-6 -mt-3 bg-white border-4 border-[#f07f34] rounded-full top-1/2"></div>
        </div>
        <div className="relative p-4 my-6 text-gray-800 bg-white rounded-xl col-start-6 col-end-10 mr-auto">
          <h3 className="text-lg font-semibold lg:text-xl text-[#f07f34]">
            Publishing
          </h3>
          <p className="mt-2 leading-6">
            We facilitate the website/app&apos;s launch to ensure your product
            reaches.
          </p>
        </div>
      </div>
